...
const ProfileModal = () => {
    ...
    return (
        <View style={{ position: 'absolute' }}>
            <Modal style={{ margin: 0, marginTop: -statusBarHeight }} backdropColor='transparent' animationOutTiming={1} animationInTiming={1} animationIn={'fadeIn'} animationOut={'fadeOut'} onBackdropPress={() => store.setModal(false)} isVisible={store.profileModal}>
                <View style={{ backgroundColor: 'white', gap: vs(25), width: vs(220), height: 'auto', position: 'absolute', top: isTablet ? '5%' : '15%', right: '10%', padding: vs(15), borderRadius: 10, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.22, shadowRadius: 2, elevation: 3 }}>
