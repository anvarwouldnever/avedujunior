    ...
    return (
        <View style={{ flexDirection: 'row', paddingHorizontal: vs(5), width: '85%', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <View style={{ width: '20%', alignItems: 'center', rowGap: vs(20) }}>
                <Text style={{ fontSize: isPad ? vs(18) : vs(16) }}>
                    {labels.observed || 'Наблюдается'}
                </Text>
            ...
            <Text style={{ fontSize: isPad ? vs(18) : vs(16), width: '20%', textAlign: 'center' }}>
                {labels.educatorComment || 'Комментарий педагога'}
            </Text>
