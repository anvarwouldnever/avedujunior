    ...
    return (
        <View style={{ gap: vs(35), marginBottom: 100 }}>
            ...
            <View style={{gap: vs(10)}}>
                ...
                <Text style={{color: '#333333', fontSize: isTablet? vs(14 + 4) : s(14), fontWeight: '500'}}>{translations[store.language].старыйпароль}</Text>
            ...
            <View style={{gap: vs(10)}}>
                ...
                <Text style={{color: '#333333', fontSize: isTablet? vs(14 + 4) : s(14), fontWeight: '500'}}>{translations[store.language].новыйпароль}</Text>
            ...
            <View style={{gap: vs(10)}}>
                ...
                <Text style={{color: '#333333', fontSize: isTablet? vs(14 + 4) : s(14), fontWeight: '500'}}>{translations[store.language].повторитеновыйпароль}</Text>
                ...
                {success && <Animated.Text entering={FadeIn} exiting={FadeOut} style={{ color: '#59E956', fontSize: isTablet ? vs(18) : vs(16), fontWeight: '500', marginTop: vs(20) }}>{'Вы успешно изменили пароль!'}</Animated.Text>}
            ...
            <TouchableOpacity onPress={() => changePassword(oldPassword, newPassword, newPassword2)} style={{ backgroundColor: '#9087E5', width: '50%', justifyContent: 'center', alignItems: 'center', padding: vs(15), borderRadius: 20, maxWidth: 200 }}>
                {loading ? 
                    <ActivityIndicator size={isTablet ? vs(18) : vs(16)} color={'white'} style={{ alignSelf: 'center' }} />
                :
                    <Text style={{ color: 'white', fontSize: isTablet ? vs(18) : vs(16), textAlign: 'center', fontWeight: '500' }}>Сохранить</Text>
                }
            </TouchableOpacity>
