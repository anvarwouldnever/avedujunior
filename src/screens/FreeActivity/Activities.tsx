    ...
    return (
        <View style={{flexWrap: 'wrap', gap: vs(20), width: '100%'}}>
            {activities?.map((act, index) => {
                ...
                return (
                    <TouchableOpacity onPress={() => setActivity(act.id)} activeOpacity={0.8} key={index} style={{width: '100%', height: Platform.isPad? vs(135) : s(100), borderRadius: vs(16), gap: Platform.isPad? vs(20) : s(20), backgroundColor: isSelected ? '#6A5AE0' : '#EFEEFC', flexDirection: 'row', alignItems: 'center', paddingHorizontal: Platform.isPad? vs(20) : s(20)}}>
                        <Image source={act?.pic} style={{width: s(65), height: Platform.isPad? vs(100) : s(65), backgroundColor: 'white', borderRadius: vs(20), resizeMode: 'contain'}}/>
